...
contract AddressRegistry is Ownable {
    ...
    /**
     @notice Update Griffin contract
     @dev Only admin
     */
    function updateGriffin(address _griffin) external onlyOwner {
        require(
            IERC165(_griffin).supportsInterface(INTERFACE_ID_ERC721),
            "Not ERC721"
        );
        griffin = _griffin;
    }
